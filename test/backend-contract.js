...
const SHEETS = {
  ...
  'Challenge Ranking': [
    ...
    ['Rookie Kid','FR - Creative Tech 2','<6 months',1000,0.1,500,0.1,0,3,2],   // is_rookie + yellow_meetings
...
eq('people count (Morocco filtered)', p.people.length, 2);
eq('is_rookie derived', p.people[1].is_rookie, true);
eq('yellow_meetings derived', p.people[1].yellow_meetings, true);
